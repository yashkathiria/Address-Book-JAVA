...
public class Add extends Main {
	public static void add_contact() throws IOException, FileNotFoundException {
		...
		if (f1 == "" || f2 == "" || f5 == "" || f6 == "" || f8 == "" || f3 == -1 || f4 == -1 || f7 == -1 || f9 == -1) {// i
																														// check
																														// that
																														// all
																														// variables
			...
			str = f1 + "," + f2 + "," + String.valueOf(f3) + "," + String.valueOf(f4) + "," + f5 + "," + f6 + ","
					+ String.valueOf(f7) + "," + f8 + "," + String.valueOf(f9);
			PrintWriter out = new PrintWriter(new BufferedWriter(new FileWriter(file1, true)));// with these code I add
...
// File file1 = new File(System.getProperty("user.dir") + "/src/contacts.txt");
// // we get the file
// BufferedReader reader1 = new BufferedReader(new FileReader(file1)); // we get
// reader for the file
// OutputStreamWriter writer1 = new OutputStreamWriter(
// new FileOutputStream(System.getProperty("user.dir") + "/src/contacts.txt",
// true), "UTF-8");
// BufferedWriter writer = new BufferedWriter(writer1);// this is a way to get a
// writer for th specific file
// Scanner input = new Scanner(System.in);
// boolean duplicate, valid;
// String currentLine1;
// String f1 = "";// I initialize the variables to avoid errors
...
// System.out.println("Give Surname: ");
// f2 = input.nextLine();
// do {// this is a do-while loop in which I check for valid input (must me
// integer)
// // and i loop through the txt file again to check if input is duplicate
// duplicate = false;
// valid = true;
...
// // attribute
// // assigned
// System.out.println("You gave false inputs, adding new contact wasn't
// successful: ");
// } else {// if everything is correct i build a string
// str = f1 + "," + f2 + "," + String.valueOf(f3) + "," + String.valueOf(f4) +
// "," + f5 + "," + f6 + ","
// + String.valueOf(f7) + "," + f8 + "," + String.valueOf(f9);
// PrintWriter out = new PrintWriter(new BufferedWriter(new FileWriter(file1,
// true)));// with these code I add
// // a line at the bottom
// // of the file
// out.println(str);
// out.close();
